...
module.exports = function(grunt){
  grunt.registerTask('generate-fonts', 'generates xml fonts from image fonts', function(glob){

    var async = grunt.util.async;

    var task = this;
    if(glob){
      var pngs = grunt.file.expand(glob);
      ...
      grunt.fail.fatal("You must provide a glob from which to process fonts");
    }
